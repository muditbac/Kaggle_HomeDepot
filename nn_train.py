...
y_pred = graph.predict_on_batch(
    {'input_features': test_input_features, 'product_uid': test_product_uid, 'query_vector': test_query_vectors})[
    'output']
...
train_y_pred = \
    graph.predict({'input_features': input_features, 'product_uid': product_uid, 'query_vector': train_query_vectors})[
        'output']
