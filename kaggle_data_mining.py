# coding=utf-8
# They should call it data Youring... (how many times have you see this splash screen?)
import time

start_time = time.time()
# hack-r.com
# linkedin.com/in/datasci
# Enjoy the smooth nerd stylings of Mr. YTCracker www.ytcrakcer.com
import numpy as np
import pandas as pd
...
df_brand = df_attr[df_attr.name == "MFG Brand Name"][["product_uid", "value"]].rename(
    columns={"value": "brand"})  # hack-r.com
